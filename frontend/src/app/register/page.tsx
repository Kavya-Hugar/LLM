...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to courses page after registration
      router.push('/courses')
    } catch (error) {
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="relative">
            <div className="w-full h-96 bg-gradient-to-br from-primary-400 to-primary-600 rounded-3xl flex items-center justify-center">
            ...
            <div className="mt-8 text-center">
              ...
              <p className="text-lg text-gray-600">
                Join thousands of learners experiencing personalized education with our AI-powered platform.
              </p>
            </div>
          </div>
        </motion.div>
